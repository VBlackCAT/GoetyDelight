...
public class TheBoxOfTheDeadItem extends Item {
    private static final ResourceLocation URN_LOOT_TABLE = new ResourceLocation("goety", "chests/crypt_urn");
    ...
    private void generateUrnLoot(Player player, ServerLevel level) {
        try {
            LootTable lootTable = level.getServer().getLootData().getLootTable(URN_LOOT_TABLE);
