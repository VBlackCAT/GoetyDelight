...
public class WarpedWartOmeletteItem extends Item {
    public WarpedWartOmeletteItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level world, LivingEntity entity) {
        ...
        if (!world.isClientSide && world instanceof ServerLevel serverLevel) {
            ...
            // 处理每个正面效果
            for (MobEffectInstance effectInstance : beneficialEffects) {
