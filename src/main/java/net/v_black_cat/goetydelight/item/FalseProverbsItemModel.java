...
public class FalseProverbsItemModel<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.parse("goetydelight:false_proverbs_model"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone2 = knife.addOrReplaceChild("bone2", CubeListBuilder.create()
                .texOffs(15, 38).addBox(-1.0F, -2.0F, -10.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.15F))
                ...
                .texOffs(29, 38).addBox(-1.5F, -1.5F, -11.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 8.0F, 1.0F));

        // ★ 从原文件完整复制 cube_r1 到 cube_r13 ★
        ...
        PartDefinition cube_r2 = bone2.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(8, 47).addBox(-6.7269F, -0.995F, 4.7269F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.15F)).texOffs(29, 15).addBox(-10.3533F, -0.007F, 4.6033F, 5.75F, 0.002F, 5.75F, new CubeDeformation(0.0F)).texOffs(29, 21).addBox(-6.7723F, -0.495F, 2.7723F, 4.0F, 1.0F, 4.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(0.0F, -1.005F, -0.9991F, 0.0F, 0.7854F, 0.0F));
        ...
        PartDefinition cube_r6 = bone2.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(43, 38).addBox(2.9486F, -0.995F, -4.0847F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(37, 46).addBox(1.9486F, -0.995F, -5.0847F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.005F, 0.0009F, 0.0F, -0.3927F, 0.0F));
        ...
        PartDefinition cube_r9 = bone2.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(37, 43).addBox(-3.9486F, -0.995F, -5.0847F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(43, 38).addBox(-3.9486F, -0.995F, -4.0847F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.005F, 0.0009F, 0.0F, 0.3927F, 0.0F));
        ...
        PartDefinition group = knife.addOrReplaceChild("group", CubeListBuilder.create()
                .texOffs(0, 3).addBox(1.5F, 8.5F, -1.25F, -3.0F, -3.0F, -3.0F, new CubeDeformation(0.0F))
                .texOffs(4, 8).addBox(-0.5F, 6.5F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(2, 8).addBox(1.0F, 8.0F, -1.75F, -2.0F, -2.0F, -2.0F, new CubeDeformation(0.0F)),
    ...
    // ★ 修复：使用正确签名的 renderToBuffer
    @Override
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        knife.render(poseStack, vertexConsumer, packedLight, packedOverlay);
    }
}