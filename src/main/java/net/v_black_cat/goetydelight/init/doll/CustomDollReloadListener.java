...
public class CustomDollReloadListener implements ResourceManagerReloadListener {
    ...
    public static final ResourceLocation DEFAULT_TEXTURE_ID = ResourceLocation.fromNamespaceAndPath(
            GoetyDelight.MODID,
            "textures/block/doll/doll_5152.png"
    );
    private static final ResourceLocation DEFAULT_MODEL_ID = ResourceLocation.fromNamespaceAndPath(
            GoetyDelight.MODID,
            "models/block/doll/custom_doll.json"
    );
    @Override
    ...
    private static void readDefaultModel(ResourceManager manager) {
        manager.getResource(DEFAULT_MODEL_ID).ifPresent(res -> {
