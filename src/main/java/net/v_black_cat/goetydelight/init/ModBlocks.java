...
//    public static final DeferredBlock<Block> NIGHT_STOVE;
...
//                () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).noLootTable()));
//
...
//    }
//
//    private static <T extends Block> DeferredHolder<Item, BlockItem> registerBlockItem(String name, DeferredBlock<T> block, int stackSize) {
