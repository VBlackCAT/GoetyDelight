...
public class SnapUnholyTripeBlock extends FeastBlock {
    public SnapUnholyTripeBlock(Properties properties, Supplier<Item> servingItem, boolean hasLeftovers) {
    ...
    public VoxelShape makeShape(){
        ...
        shape = Shapes.join(shape, Shapes.box(0, 0.1875, 0.375, 0.125, 0.3125, 0.625), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0.875, 0.1875, 0.375, 1, 0.3125, 0.625), BooleanOp.OR);
