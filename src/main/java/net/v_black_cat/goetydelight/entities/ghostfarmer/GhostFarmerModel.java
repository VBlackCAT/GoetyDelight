...
import net.v_black_cat.goetydelight.init.ModAnimationDefinitions;
...
public class GhostFarmerModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        handl.addOrReplaceChild("robel", CubeListBuilder.create().texOffs(24, 52).addBox(-2.0F, -3.0F, -2.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        handr.addOrReplaceChild("rober", CubeListBuilder.create().texOffs(40, 52).addBox(-2.0F, -3.0F, -2.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        head.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, 0.0F, -6.0F, 16.0F, 0.01F, 16.0F, new CubeDeformation(0.0F))
                .texOffs(32, 40).addBox(-7.0F, -4.0F, -2.0F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -6.0F, -2.0F));
        head.addOrReplaceChild("robehead", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -7.0F, -4.0F, 8.0F, 15.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        bodyskeleton.addOrReplaceChild("skull", CubeListBuilder.create().texOffs(56, 21).addBox(-3.0F, 3.95F, -3.5F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity instanceof GhostFarmerEntity ghostFarmer) {
