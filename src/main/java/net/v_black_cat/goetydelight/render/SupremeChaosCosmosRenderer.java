...
public final class SupremeChaosCosmosRenderer {
    ...
    public static void render(RenderLevelStageEvent event, Entity entity, ActiveEntityVisualEffect effect) {
        ...
        // Build three differently-tilted orbital planes for the layered effect
        ...
        // ---- Pass 1: Chaos outer aura (tilted plane 2) ----
        ...
        // ---- Pass 2: Sacred light burst (vertical plane) ----
        ...
        // ---- Pass 3: Triple holy halo rings (tilted plane 1 - main halo) ----
        ...
        // ---- Pass 4: Star orbit trail (same plane as halo) ----
        ...
        // ---- Pass 5: Sparkle particle shower (vertical plane, facing camera) ----
    ...
    private static void drawOrbitingStars(Matrix4f matrix, Vec3 cameraPos, Vec3 xAxis, Vec3 yAxis,
        ...
        // Draw small quad "stars" at orbiting positions
        for (int i = 0; i < 10; i++) {
        ...
        // Secondary smaller counter-orbiting sparkles
        for (int i = 0; i < 6; i++) {
